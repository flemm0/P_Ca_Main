...
```{r, eval=FALSE}
write.xlsx(ego.p05up, file = "./pathways/enrichGO/ego.p05up.xlsx")
write.xlsx(ego.p05dn, file = "./pathways/enrichGO/ego.p05dn.xlsx")
write.xlsx(ego.p01up, file = "./pathways/enrichGO/ego.p01up.xlsx")
write.xlsx(ego.p01dn, file = "./pathways/enrichGO/ego.p01dn.xlsx")
write.xlsx(ego.p001up, file = "./pathways/enrichGO/ego.p001up.xlsx")
write.xlsx(ego.p001dn, file = "./pathways/enrichGO/ego.p001dn.xlsx")
write.xlsx(ego.fdr1up, file = "./pathways/enrichGO/ego.fdr1up.xlsx")
write.xlsx(ego.fdr1dn, file = "./pathways/enrichGO/ego.fdr1dn.xlsx")
```
