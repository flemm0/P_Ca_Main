...
Malignant Caucasian American VS Nonmalignant Caucasian American

```{r}
knitr::opts_chunk$set(root.dir = "~/Desktop/velvilab/P_Ca_Analysis/second-analysis/mal-ca-vs-nonmal-ca")
```
