...
Malignant Caucasian American VS Nonmalignant African American

```{r}
knitr::opts_chunk$set(root.dir = "~/Desktop/velvilab/P_Ca_Analysis/second-analysis/mal-ca-vs-nonmal-aa")
```
...
par(mfrow=c(3,3))
for (i in 1:8) { ## k must be less than number of samples (which is 9 in this case)
