...
```{r}
knitr::opts_chunk$set(root.dir = "~/Desktop/velvilab/P_Ca_Analysis/second-analysis/mal-aa-vs-nonmal-ca")
```
...
lapply(all.msig.res, nrow) ## not enough pathways for making plots
```

```{r}
all.ego.res <- all.ego.res[c(1,2,4,6,8)]
```
